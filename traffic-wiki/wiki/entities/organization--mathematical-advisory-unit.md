---
id: "organization:mathematical-advisory-unit"
type: "Organization"
canonical_name: "Mathematical Advisory Unit"
status: "proposed"
topics: ["transport-economics", "transport-evaluation", "travel-forecasting", "uk-transport-policy", "urban-transportation-planning"]
---

# Mathematical Advisory Unit

Unit within the Economic Planning Directorate of the UK Ministry of Transport where Alan Wilson led work on transport evaluation methodology.

## Names

| Name | Language | Type | Locale | Sources |
|---|---|---|---|---|
| MAU | en | abbreviation |  | source:boyce-williams-2015-forecasting-urban-travel |
| Mathematical Advisory Unit | en | preferred |  | source:boyce-williams-2015-forecasting-urban-travel |
