---
id: "model:discrete-travel-choice-model"
type: "Model"
canonical_name: "Discrete Travel Choice Model"
status: "proposed"
topics: ["discrete-choice", "random-utility", "travel-demand-analysis"]
---

# Discrete Travel Choice Model

Probabilistic model family for travel choices among alternatives, developed within an economic framework and often based on random utility maximisation.

## Names

| Name | Language | Type | Locale | Sources |
|---|---|---|---|---|
| Discrete Travel Choice Model | en | preferred |  | source:boyce-williams-2015-forecasting-urban-travel |
| discrete travel choice models | en | alias |  | source:boyce-williams-2015-forecasting-urban-travel |
