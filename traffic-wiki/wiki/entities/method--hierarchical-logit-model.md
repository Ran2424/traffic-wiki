---
id: "method:hierarchical-logit-model"
type: "Method"
canonical_name: "Hierarchical Logit Model"
status: "proposed"
topics: ["discrete-choice", "model-structures", "multinomial-logit"]
---

# Hierarchical Logit Model

Model structure arranging conditional MNL or logit models in a hierarchy over multiple travel choice dimensions.

## Names

| Name | Language | Type | Locale | Sources |
|---|---|---|---|---|
| Hierarchical Logit Model | en | preferred |  | source:boyce-williams-2015-forecasting-urban-travel |
| hierarchy of logit models | en | alias |  | source:boyce-williams-2015-forecasting-urban-travel |
| hierarchy of MNL models | en | alias |  | source:boyce-williams-2015-forecasting-urban-travel |
